...
import com.example.donghua.adapter.PickerScrollAdapter;
import com.example.donghua.listener.OnWheelChangedListener;
import com.example.donghua.listener.OnWheelClickedListener;
import com.example.donghua.listener.OnWheelScrollListener;
import com.example.donghua.model.ItemsRange;
...
public class PickerScrollView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.layer_wheel_bg;
	private int wheelForeground = R.drawable.layer_wheel_val;
	...
	// Scrolling
	private PickerScroller scroller;
	...
	// View adapter
	private PickerScrollAdapter viewAdapter;

	// Recycle
	private PickerScrollRecycle recycle = new PickerScrollRecycle(this);
	...
	private void initData(Context context) {
		scroller = new PickerScroller(getContext(), scrollingListener);
	}
	...
	PickerScroller.ScrollingListener scrollingListener = new PickerScroller.ScrollingListener() {
		...
		public void onJustify() {
			if (Math.abs(scrollingOffset) > PickerScroller.MIN_DELTA_FOR_SCROLLING) {
	 ...
	 */
	public PickerScrollAdapter getViewAdapter() {
		return viewAdapter;
	}
	 ...
	 *            the view adapter
	 */
	public void setViewAdapter(PickerScrollAdapter viewAdapter) {
	...
	private void drawShadows(Canvas canvas) {
		// by wkw1125 @2015-9-22 20:22:04 ���ݿɼ�������������Ӱ��С
